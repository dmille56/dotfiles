...
(setq-default elfeed-feeds-yt
	...
	("https://www.youtube.com/feeds/videos.xml?channel_id=UCzN7S0O87X-Q1CJqyWnJ9mw" yt i)
        ("https://www.youtube.com/feeds/videos.xml?channel_id=UCsEPI9OwGEw5Lm0E7Paq62g" yt i)
...
(setq-default elfeed-feeds-podcasts
      '(
        ...
        ("https://feeds.megaphone.fm/HS2300184645" pc podcast i) ;; My First Million
        ))
...
(defun yt-video-is-short (url)
  ...
  (let*
      (
       (duration-str (shell-command-to-string
                      (concat "yt-dlp --get-duration " (shell-quote-argument url))))
